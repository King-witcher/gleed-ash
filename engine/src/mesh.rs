...
fn make_vertex_buffer(transfer: &mut TransferContext, vertices: &[Vertex]) -> Result<Buffer> {
...
fn make_index_buffer(transfer: &mut TransferContext, indices: &[u32]) -> Result<Buffer> {
